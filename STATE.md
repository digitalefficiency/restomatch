...
**Next planned task:** Pilot gate (plan §8a). Remaining: Phase 2 cred-gated activation when keys arrive; leak heatmap needs price baselines (3+ samples) to populate; optional per-IP rate-limit on leads.create.
**Open blockers:** none
